        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Discounts_MinimumOrderAmount_NonNegative", "[MinimumOrderAmount] IS NULL OR [MinimumOrderAmount] >= 0");
                    table.CheckConstraint("CK_Discounts_Value_Positive", "[Value] > 0");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountUsages_DiscountId_UserId",
                table: "DiscountUsages",
                columns: new[] { "DiscountId", "UserId" },
                unique: true);
