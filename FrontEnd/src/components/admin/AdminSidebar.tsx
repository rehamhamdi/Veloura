...
function AdminSidebar({ open, activeItem, onClose, onSelect }: AdminSidebarProps) {
  ...
  const labels: Record<string, string> = { Dashboard: t('admin.dashboard'), Products: t('admin.products'), Categories: t('admin.categories'), Orders: t('admin.orders'), Customers: t('admin.customers') }
