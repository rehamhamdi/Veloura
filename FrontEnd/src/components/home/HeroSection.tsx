    ...
    <section id="home" className="mx-auto grid max-w-[1320px] items-center gap-12 px-6 pb-20 pt-10 sm:pt-16 lg:grid-cols-[.88fr_1.12fr] lg:gap-16 lg:px-10 lg:pb-28 lg:pt-20">
      <div className="max-w-[540px]">
        ...
        <div className="mt-9 flex flex-wrap items-center gap-4">
          <a className="inline-flex h-12 items-center gap-3 rounded-full bg-[#6d4946] px-7 text-[13px] font-bold text-[#fffaf5] shadow-[0_10px_24px_rgba(109,73,70,.16)] transition hover:-translate-y-0.5 hover:bg-[#583a38]" href="#shop">Shop Now <ArrowRight size={16} /></a>
          <a className="inline-flex h-12 items-center rounded-full border border-[#d8bbb0] px-7 text-[13px] font-semibold text-[#76504c] transition hover:bg-[#f1e3dc]" href="#categories">Explore Collection</a>
        </div>
