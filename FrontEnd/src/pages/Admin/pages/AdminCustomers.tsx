...
function AdminCustomers() {
  ...
  return <AdminShell activeItem="Customers"><main className="min-h-[calc(100vh-76px)] bg-[#f8f3ed] px-5 py-8 sm:px-8 lg:px-10 lg:py-10"><div className="mx-auto max-w-[1440px]">
    <div className="mb-8 flex flex-col justify-between gap-5 sm:flex-row sm:items-end"><div><p className="mb-2 text-[11px] font-bold uppercase tracking-[.18em] text-[#a86f6b]">Workspace / Customers</p><h2 className="font-['Playfair_Display'] text-[clamp(2rem,4vw,2.75rem)] font-medium leading-tight text-[#3b2a29]">Customers</h2><p className="mt-2 text-sm text-[#806967]">Keep every customer conversation close to the Veloura ritual.</p></div><div className="flex items-center gap-2 rounded-full bg-[#f3e4dc] px-3 py-2 text-[11px] font-bold text-[#8e5d5a]"><Mail size={14} />Contact inbox</div></div>
