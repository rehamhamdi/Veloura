...
const products: AdminProduct[] = [
  ...
  },
  {
    ...
    status: "Low stock",
    image:
      "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=320&q=85",
  },
  {
    id: 3,
    ...
    status: "Active",
    image:
      "https://images.unsplash.com/photo-1611930022073-b7a4ba5fcccd?auto=format&fit=crop&w=320&q=85",
  },
  {
    id: 4,
    name: "Rosewater Essence",
    category: "Essences",
    price: "$31.00",
    stock: 0,
    sold: 219,
    status: "Out of stock",
    image:
      "https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?auto=format&fit=crop&w=320&q=85",
  },
  {
    id: 5,
    name: "Silk Veil SPF 30",
    category: "Sun care",
    price: "$26.00",
    stock: 118,
    sold: 195,
    status: "Active",
    image:
      "https://images.unsplash.com/photo-1556229010-6c3f2c9ca5f8?auto=format&fit=crop&w=320&q=85",
  },
  {
    id: 6,
    ...
    status: "Low stock",
    image:
      "https://images.unsplash.com/photo-1598440947619-2c35fc9b9f8?auto=format&fit=crop&w=320&q=85",
  },
];
      ...
      <main className="min-h-[calc(100vh-76px)] bg-[#f8f3ed] px-5 py-8 sm:px-8 lg:px-10 lg:py-10">
        <div className="mx-auto max-w-[1440px]">
          ...
          <section className="mb-6 grid gap-3 sm:grid-cols-3">
            <div className="rounded-[14px] border border-[#eaded5] bg-[#fffdf9] p-4">
              <p className="m-0 text-[11px] font-semibold text-[#a38b83]">
                Total products
              </p>
              <p className="mb-0 mt-2 font-['Playfair_Display'] text-2xl text-[#493331]">
                186
              </p>
            </div>
            <div className="rounded-[14px] border border-[#eaded5] bg-[#fffdf9] p-4">
            ...
            <div className="mb-6 flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
              <div>
                ...
                <p className="mb-0 mt-2 text-xs text-[#a38b83]">
                  Manage your skincare collection and inventory.
                </p>
              </div>
            ...
            {filteredProducts.length === 0 ? (
              ...
              <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                {filteredProducts.map((product) => (
                  <article
                    key={product.id}
                    className="group overflow-hidden rounded-[14px] border border-[#eee3dc] bg-[#fffaf5] transition hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(91,55,53,.08)]"
                  >
                    <div className="relative h-[190px] overflow-hidden bg-[#ead9cf]">
                      <img
                      ...
                      />
                      <button
                        className="absolute right-3 top-3 grid h-8 w-8 place-items-center rounded-full bg-[#fffdf9]/90 text-[#806967] shadow-sm"
                        aria-label={`More actions for ${product.name}`}
                      >
                        <MoreHorizontal size={16} />
                      </button>
                      <span
                        className={`absolute bottom-3 left-3 rounded-full px-2.5 py-1 text-[10px] font-bold ${statusStyles[product.status]}`}
                      >
                        {product.status}
                      </span>
                    </div>
                    <div className="p-4">
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          <p className="m-0 text-xs font-bold text-[#493331]">
                            {product.name}
                          </p>
                        ...
                        <p className="m-0 text-sm font-bold text-[#6d4946]">
                          {product.price}
                        </p>
                      </div>
                      <div className="mt-5 flex items-end justify-between border-t border-[#f0e5de] pt-3">
                        <div>
                          <p className="m-0 text-[10px] text-[#a38b83]">
                            Inventory
                          </p>
                          <p
                            className={`m-0 mt-1 text-xs font-bold ${product.stock === 0 ? "text-[#a36c69]" : product.stock < 40 ? "text-[#9a713c]" : "text-[#63846f]"}`}
                          >
                            {product.stock} units
                          </p>
                        </div>
